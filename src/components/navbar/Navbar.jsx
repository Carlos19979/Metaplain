...
export default function Navbar() {
  ...
  return (
    ...
    <ul className={`md:flex md:items-center md:pb-0 pb-10 absolute md:static bg-blue-400 md:z-auto z-[-1] left-0 w-full md:w-auto md:pl-0 pl-9 transition-all duration-00 ease-in ${open ? 'top-16 ':'top-[-490px]'}`}>
      {
        links.map((link)=>(
